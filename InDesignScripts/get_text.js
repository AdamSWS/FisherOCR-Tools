// InDesign Text Extractor with Safe Text Processing
            ...
            for (var j = 0; j < story.textContainers.length; j++) {
                ...
                try {
                    ...
                    if (onPage && parentPage) {
                        ...
                        // Safe method for line detection - handle both string and non-string content
                        if (typeof frameText === "string" && frameText.indexOf("\r") !== -1) {
                            // Text contains line breaks, try to split it
                            ...
                            if (textLines.length > 1) {
                                ...
                                for (var k = 0; k < textLines.length; k++) {
                                    var lineText = String(textLines[k]);
                                    lineText = lineText.replace(/^\s+|\s+$/g, ""); // Safe way to trim
                            ...
                            // For single line text or non-string content, just use a slightly smaller box than the frame
                            ...
                            coordsFile.write(storyCount + "," + 
                                            ...
                                            width + "," + 
                                            lineHeight + "," + 
                                            "\"" + String(frameText).replace(/"/g, "\"\"").replace(/[\r\n]/g, " ") + "\"\n");
