...
def validate_and_clean_labels(label_file):
    ...
    if missing_files:
        print("Missing Files (Removed from Label.txt):")
        for file in missing_files:
            print(file)
    else:
        print("All images exist!")

# Run the validation and cleaning for Label.txt
validate_and_clean_labels("Label.txt")
